...
export STACK_PLANNER_RETREAT_BOX_PENALTY=${STACK_PLANNER_RETREAT_BOX_PENALTY:-25.0}
...
# Keep four minibatches per PPO epoch as env/horizon scale. A fixed 512 at
# 2048 envs creates 128 minibatches per epoch and 32x too many optimizer steps.
...
export STACK_PLANNER_GAE=${STACK_PLANNER_GAE:-0.95}
...

{
    ...
    for name in CUDA_VISIBLE_DEVICES STACK_PLANNER_OUTPUT STACK_PLANNER_SEED \
        ...
        STACK_PLANNER_GAMMA STACK_PLANNER_GAE STACK_PLANNER_CLIP \
