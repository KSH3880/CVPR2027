...
export CARRY_PLANNER_ANALYTIC_TIME_UNCERTAINTY=${CARRY_PLANNER_ANALYTIC_TIME_UNCERTAINTY:-1.5}
export CARRY_PLANNER_ANALYTIC_TIME_SAMPLES=${CARRY_PLANNER_ANALYTIC_TIME_SAMPLES:-7}
export CARRY_PLANNER_REPLAN_CONSISTENCY_COEF=${CARRY_PLANNER_REPLAN_CONSISTENCY_COEF:-0.01}
export CARRY_PLANNER_EXCESS_LENGTH_COEF=${CARRY_PLANNER_EXCESS_LENGTH_COEF:-0.02}
export CARRY_PLANNER_FREE_DETOUR_RATIO=${CARRY_PLANNER_FREE_DETOUR_RATIO:-1.20}
export CARRY_PLANNER_PATH_REGULARIZATION_WARMUP=${CARRY_PLANNER_PATH_REGULARIZATION_WARMUP:-20}
