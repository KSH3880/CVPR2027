...
export STACK_PROBE_OUT=/home/hwanhee/koo_cvpr/runs/stack_bootstrap/natural_obs_compare_20260914
...
python -u ../runs/stack_bootstrap/natural_obs_compare_20260914/compare.py --task HumanoidMASequentialStackRelease --cfg_train "$MS_TRAINCFG" --cfg_env "$STACK_PROBE_OUT/env.yaml" --motion_file tokenhsi/data/dataset_loco_sit_carry_climb.yaml --hrl_checkpoint "$MS_CKPT" --checkpoint "$MA_INIT_CKPT" --test --eval --eval_task carry --headless --graphics_device_id -1 --seed 0
