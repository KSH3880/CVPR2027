...
NUM_OBJECTS=${4:-3}
NUM_REPEATS=${5:-3}
RELATION_ENV_CFG=tokenhsi/data/cfg/multi_agent/approach_distance_edge_context_success.yaml
RELATION_OUTPUT_DEFAULT=output/approach_distance_edge_context_success
set --
