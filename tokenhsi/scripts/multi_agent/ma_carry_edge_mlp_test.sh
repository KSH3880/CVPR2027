#!/bin/bash
# Test/evaluate an A2 edge-embedding relation-bias checkpoint.
#   sh tokenhsi/scripts/multi_agent/ma_carry_edge_mlp_test.sh <checkpoint.pth> [num_agents] [num_envs] [num_objects] [num_repeats] [eval_skills] [eval_skill_probs]
