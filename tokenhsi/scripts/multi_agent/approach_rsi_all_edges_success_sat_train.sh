...
NUM_ENVS=${2:-2048}
NUM_OBJECTS=${3:-3}
RELATION_ENV_CFG=tokenhsi/data/cfg/multi_agent/approach_rsi_all_edges_success_sat.yaml
RELATION_OUTPUT_DEFAULT=output/approach_rsi_all_edges_success_sat
...
python ./tokenhsi/run.py --task HumanoidMACarry \
    ...
    --experiment ApproachRSIAllEdgesSuccessSat \
    --headless --no_video "$@"
