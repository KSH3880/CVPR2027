...
NUM_ENVS=${2:-2048}
NUM_OBJECTS=${3:-3}
RELATION_ENV_CFG=tokenhsi/data/cfg/multi_agent/approach_rsi_all_edges.yaml
RELATION_OUTPUT_DEFAULT=output/approach_rsi_all_edges
...
python ./tokenhsi/run.py --task HumanoidMACarry \
    ...
    --experiment ApproachRSIAllEdges \
    --headless --no_video "$@"
