...
NUM_ENVS=${2:-2048}
NUM_OBJECTS=${3:-3}
RELATION_ENV_CFG=tokenhsi/data/cfg/multi_agent/amp_humanoid_ma_carry_relation_state02_near_dir_success10_approach.yaml
RELATION_OUTPUT_DEFAULT=output/ma_carry_relation_state02_near_dir_success10_approach
...
python ./tokenhsi/run.py --task HumanoidMACarry \
    ...
    --experiment CarryRelationState02NearDirSuccess10Approach \
    --headless --no_video "$@"
