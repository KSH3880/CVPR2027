...
NUM_ENVS=${2:-2048}
NUM_OBJECTS=${3:-3}
RELATION_ENV_CFG=tokenhsi/data/cfg/multi_agent/approach_distance_success_no_sat.yaml
RELATION_OUTPUT_DEFAULT=output/approach_distance_success_no_sat
...
python ./tokenhsi/run.py --task HumanoidMACarry \
    ...
    --experiment ApproachDistanceSuccessNoSat \
    --headless --no_video "$@"
