...
NUM_ENVS=${2:-2048}
NUM_OBJECTS=${3:-3}
RELATION_ENV_CFG=tokenhsi/data/cfg/multi_agent/approach_distance_success_holding_k10.yaml
RELATION_OUTPUT_DEFAULT=output/approach_distance_success_holding_k10
...
python ./tokenhsi/run.py --task HumanoidMACarry \
    ...
    --experiment ApproachDistanceSuccessHoldingK10 \
    --headless --no_video "$@"
