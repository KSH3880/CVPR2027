...
NUM_ENVS=${2:-2048}
NUM_OBJECTS=${3:-3}
RELATION_ENV_CFG=tokenhsi/data/cfg/multi_agent/amp_humanoid_ma_carry_relation_state02.yaml
RELATION_OUTPUT_DEFAULT=output/ma_carry_relation_state02
...
python ./tokenhsi/run.py --task HumanoidMACarry \
    ...
    --experiment CarryRelationState02 \
    --headless --no_video "$@"
