...
REPLAY_NAMES=(
    ...
    MA_TOKENIZER_ZERO MA_TOKEN MA_FREEZE_NEW_CARRY MA_SEP MA_SPAWN_GAP MA_C MA_BETA
    ...
    STACK_ENTRY_STEPS STACK_HAND_CLEAR STACK_HAND_STEPS STACK_STABLE_LIN STACK_STABLE_ANG STACK_TOP_STEPS
    STACK_DROP_XY STACK_TRANSITION_BONUS STACK_CLEAR_BONUS STACK_CLEAR_PROGRESS_W STACK_CLEAR_SPEED_W
...
export MA_K MA_TEAM MA_MKSPN MA_TREF MA_NOFREEZE MA_FREEZE_NEW_CARRY MA_TRAJ MA_TRAJ_ENVS MA_TRAJ_STEPS
...
export STACK_ENTRY_STEPS STACK_HAND_CLEAR STACK_HAND_STEPS STACK_STABLE_LIN STACK_STABLE_ANG STACK_TOP_STEPS
export STACK_DROP_XY STACK_TRANSITION_BONUS STACK_CLEAR_BONUS STACK_CLEAR_PROGRESS_W STACK_CLEAR_SPEED_W
