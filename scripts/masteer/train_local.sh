...
REPLAY_NAMES=(
    ...
    STACK_SEED STACK_SIZE_MARGIN STACK_GOAL_X STACK_GOAL_Y STACK_STAGE_DIST STACK_STAGE_Z STACK_STAGE_TOL STACK_STAGE_HAND_TOL STACK_STAGE_STABLE_LIN STACK_STAGE_STABLE_ANG STACK_STAGE_HOLD_STEPS STACK_REQUIRE_STAGED STACK_PRE_STEPS STACK_PHASE_STEPS STACK_BOOTSTRAP_FRAC STACK_BOOTSTRAP_KEEP_WAIT STACK_BOOTSTRAP_EVAL STACK_HUMANOID_STABILITY_W
...
export STACK_SEED STACK_SIZE_MARGIN STACK_GOAL_X STACK_GOAL_Y STACK_STAGE_DIST STACK_STAGE_Z STACK_STAGE_TOL STACK_STAGE_HAND_TOL STACK_STAGE_STABLE_LIN STACK_STAGE_STABLE_ANG STACK_STAGE_HOLD_STEPS STACK_REQUIRE_STAGED STACK_PRE_STEPS STACK_PHASE_STEPS STACK_BOOTSTRAP_FRAC STACK_BOOTSTRAP_KEEP_WAIT STACK_BOOTSTRAP_EVAL STACK_HUMANOID_STABILITY_W
