...
REPLAY_NAMES=(
    ...
    STACK_REHEARSAL_FRAC STACK_VIRTUAL_RETREAT_BOX STACK_DYNAMIC_CARRY_MASK STACK_SEQUENTIAL_REWARD_MASK
...
export STACK_REHEARSAL_FRAC STACK_VIRTUAL_RETREAT_BOX STACK_DYNAMIC_CARRY_MASK STACK_SEQUENTIAL_REWARD_MASK
