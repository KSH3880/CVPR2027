...
REPLAY_NAMES=(
    ...
    MA_TOKENIZER_ZERO MA_TOKEN MA_NOFREEZE MA_FREEZE_NEW_CARRY MA_ADAPTER_ONLY MA_FREEZE_INPUT_RMS MA_SEP MA_SPAWN_GAP MA_C MA_BETA
    ...
    STACK_SEED STACK_SIZE_MARGIN STACK_GOAL_X STACK_GOAL_Y STACK_STAGE_DIST STACK_STAGE_Z STACK_STAGE_TOL STACK_STAGE_HAND_TOL STACK_STAGE_STABLE_LIN STACK_STAGE_STABLE_ANG STACK_STAGE_HOLD_STEPS STACK_REQUIRE_STAGED STACK_PRE_STEPS STACK_PHASE_STEPS
    ...
    STACK_REHEARSAL_FRAC STACK_VIRTUAL_RETREAT_BOX STACK_VIRTUAL_RETREAT_REAR_BOX STACK_ZERO_CARRY_OBS STACK_DYNAMIC_CARRY_MASK STACK_SEQUENTIAL_REWARD_MASK
...
export STACK_SEED STACK_SIZE_MARGIN STACK_GOAL_X STACK_GOAL_Y STACK_STAGE_DIST STACK_STAGE_Z STACK_STAGE_TOL STACK_STAGE_HAND_TOL STACK_STAGE_STABLE_LIN STACK_STAGE_STABLE_ANG STACK_STAGE_HOLD_STEPS STACK_REQUIRE_STAGED STACK_PRE_STEPS STACK_PHASE_STEPS
...
export STACK_REHEARSAL_FRAC STACK_VIRTUAL_RETREAT_BOX STACK_VIRTUAL_RETREAT_REAR_BOX STACK_ZERO_CARRY_OBS STACK_DYNAMIC_CARRY_MASK STACK_SEQUENTIAL_REWARD_MASK
