...
REPLAY_NAMES=(
    ...
    STACK_ENTRY_STEPS STACK_ENTRY_DELIVERED STACK_ENTRY_FOOT_GATE STACK_HAND_CLEAR STACK_HAND_STEPS STACK_HAND_ONLY_SWITCH STACK_RELEASE_FOOT_GATE STACK_FOOT_CLEAR STACK_FOOT_BOX_W STACK_CARRY_FOOT_GATE STACK_CARRY_FOOT_XY STACK_CARRY_FOOT_Z STACK_STABLE_LIN STACK_STABLE_ANG STACK_TOP_STEPS
...
export STACK_ENTRY_STEPS STACK_ENTRY_DELIVERED STACK_ENTRY_FOOT_GATE STACK_HAND_CLEAR STACK_HAND_STEPS STACK_HAND_ONLY_SWITCH STACK_RELEASE_FOOT_GATE STACK_FOOT_CLEAR STACK_FOOT_BOX_W STACK_CARRY_FOOT_GATE STACK_CARRY_FOOT_XY STACK_CARRY_FOOT_Z STACK_STABLE_LIN STACK_STABLE_ANG STACK_TOP_STEPS
