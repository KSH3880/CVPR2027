#!/bin/bash
# ms18 e9000에서 한 번의 mixed run으로 shared-goal carry/wait/stack을 학습한다.
set -euo pipefail
...
TAG=${1:-ms56_ms18e9000_sharedgoal_mixed_steeronly_6000_s0}
...
# 각각 rehearsal/snapshot reset으로 섞는다. Snapshot은 실행 중 정상 state에서만 수집한다.
export STACK_REHEARSAL_FRAC=0.20
export STACK_BOOTSTRAP_FRAC=0.15
export STACK_BOOTSTRAP_KEEP_WAIT=0
export STACK_BOOTSTRAP_CAPTURE_STABLE=1
export STACK_BOOTSTRAP_TOP_BALANCE_STEPS=8
