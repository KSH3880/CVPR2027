...
export STACK_BASE_HOLD_ANCHOR_GATE=${PILOT_BASE_HOLD_ANCHOR_GATE:-${STACK_BASE_HOLD_ANCHOR_GATE:-0}}
export STACK_BASE_LEGACY_REWARD=${PILOT_BASE_LEGACY_REWARD:-${STACK_BASE_LEGACY_REWARD:-1}}
export STACK_CLEAR_BYPASS_STAGE=${PILOT_CLEAR_BYPASS_STAGE:-${STACK_CLEAR_BYPASS_STAGE:-0}}
...
export STACK_RETREAT_SCALE=${PILOT_RETREAT_SCALE:-${STACK_RETREAT_SCALE:-1.0}}
export STACK_CLEAR_ROUTE_AROUND=${PILOT_CLEAR_ROUTE_AROUND:-${STACK_CLEAR_ROUTE_AROUND:-0}}
...
export STACK_RETREAT_ENDPOINT_TOL=${PILOT_RETREAT_ENDPOINT_TOL:-0.0}
export STACK_CLEAR_HARD_GATE=${PILOT_CLEAR_HARD_GATE:-${STACK_CLEAR_HARD_GATE:-0}}
export STACK_CLEAR_XY_TOL=${PILOT_CLEAR_XY_TOL:-${STACK_CLEAR_XY_TOL:-0.10}}
export STACK_CLEAR_Z_TOL=${PILOT_CLEAR_Z_TOL:-${STACK_CLEAR_Z_TOL:-0.06}}
export STACK_CLEAR_STABLE_LIN=${PILOT_CLEAR_STABLE_LIN:-${STACK_CLEAR_STABLE_LIN:-0.08}}
export STACK_CLEAR_STABLE_ANG=${PILOT_CLEAR_STABLE_ANG:-${STACK_CLEAR_STABLE_ANG:-0.20}}
